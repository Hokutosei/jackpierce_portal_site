...
function twentytwelve_scripts_styles() {
	...
	if ( 'off' !== _x( 'on', 'Open Sans font: on or off', 'twentytwelve' ) ) {
		...
		$query_args = array(
			'family' => 'Open+Sans:400italic,700italic,400,700|Pinyon+Script|Source+Code+Pro:200,400|Josefin+Sans:100|Cinzel',
			'subset' => $subsets,
		);
...
function twentytwelve_widgets_init() {
    ...
    register_sidebar(array(
       'name'           =>__('News', 'twentytwelve'),
        'id'            => 'news-1',
        'description'   => 'display all the news',
        'class'         => 'news_list',
        'before_widget' => '',
        'after_widget'  => '',
